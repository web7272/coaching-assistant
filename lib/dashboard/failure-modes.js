...
export const M_REGISTRY = Object.freeze({
  ...
  M66: { id: 'M66', name_zh: 'Handoff Step 4 direct-1925 phrasing 未提供 (errata v02、原「三選一未提供」)',              mode_bucket: MODE_BUCKET.CRISIS,             severity: SEVERITY_TIER.HIGH,   spec_ref: '§10.7 + errata v02' },
  M67: { id: 'M67', name_zh: '@deprecated errata v02 (原「count >= 3 仍提供 (c) 選項」、三選一機制廢除後不適用、保留 ID 防 dashboard 重排)',         mode_bucket: MODE_BUCKET.CRISIS,             severity: SEVERITY_TIER.MEDIUM,   spec_ref: 'Patch 23 + §10.7 + @deprecated errata v02' },
