...
export const LEARNER_LEVELS = Object.freeze({
  ...
  ESCALATE_VIVI:  'escalate_vivi',   // count >= 3, Vivi weekly review (errata v02: count >= 2 fires Step 4 cumulative phrasing already)
...
export const METRIC_METADATA = Object.freeze({
  ...
  alert_severities: {
    ...
    count_ge_5: 'freeze AI 推進, Vivi 主動聯絡 (HITL alert immediate, errata v02 不再 offer booking)',
