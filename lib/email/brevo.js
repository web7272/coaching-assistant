// lib/email/brevo.js
// Brevo (formerly Sendinblue) transactional email — PR-4c-green Auth rebuild
// stage 1f: sendMagicLink switched from stub → real HTTPS call to the Brevo
// REST API (no @getbrevo/brevo SDK dependency — direct fetch keeps deps tiny).
//
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#FBF6EC;padding:48px 16px;">
    <tr><td align="center">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;background:#FFFFFF;border:0.5px solid #BFD7BA;border-radius:14px;padding:40px 32px;">
        ...
        <tr><td style="height:28px;"></td></tr>
        <tr><td align="center">
          <a href="${safeLink}" style="display:inline-block;padding:14px 36px;background:#3E9D5C;color:#FFFFFF;text-decoration:none;font-size:15px;letter-spacing:4px;border-radius:10px;">登入</a>
        </td></tr>
