...
/**
 * 暖短信 + 一顆「下載你的練習」按鈕。Plain HTML (no external CSS/images) —
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f7ebe5;padding:48px 16px;">
    <tr><td align="center">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;background:#FFFFFF;border:0.5px solid #E8C6B8;border-radius:14px;padding:40px 32px;">
        ...
        <tr><td style="height:28px;"></td></tr>
        <tr><td align="center">
          <a href="${safe}" clicktracking="off" style="display:inline-block;padding:14px 36px;background:#c66b4f;color:#FFFFFF;text-decoration:none;font-size:15px;letter-spacing:4px;border-radius:10px;">下載你的練習</a>
        </td></tr>
        <tr><td style="height:24px;"></td></tr>
        <tr><td style="font-size:11px;color:#9c8c87;line-height:1.7;">
          如果按鈕沒反應，把這串貼進瀏覽器：<br>
          <span style="word-break:break-all;color:#6b5c57;">${safe}</span>
        </td></tr>
        <tr><td style="height:28px;"></td></tr>
        <tr><td style="font-size:11px;font-style:italic;color:#9c8c87;text-align:right;">— 教練</td></tr>
      </table>
