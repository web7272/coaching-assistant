...
export function buildMagicLinkHtml(link) {
  ...
  return `<!DOCTYPE html>
<html lang="zh-TW">
<body style="margin:0;padding:0;background:#f7ebe5;font-family:'Noto Serif TC',Georgia,serif;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f7ebe5;padding:48px 16px;">
    <tr><td align="center">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;background:#FFFFFF;border:0.5px solid #E8C6B8;border-radius:14px;padding:40px 32px;">
        <tr><td style="text-align:center;font-size:13px;letter-spacing:4px;color:#c66b4f;">看見自己</td></tr>
        <tr><td style="height:14px;"></td></tr>
        <tr><td style="text-align:center;">
          <div style="width:24px;height:0.5px;background:#d6826a;margin:0 auto;"></div>
        </td></tr>
        <tr><td style="height:28px;"></td></tr>
        <tr><td style="font-size:15px;line-height:2;color:#2d2422;">
          點下面這顆按鈕就能進來——<br>
          只屬於這封信、60 分鐘內有效。
        </td></tr>
        <tr><td style="height:28px;"></td></tr>
        <tr><td align="center">
          <a href="${safeLink}" clicktracking="off" style="display:inline-block;padding:14px 36px;background:#c66b4f;color:#FFFFFF;text-decoration:none;font-size:15px;letter-spacing:4px;border-radius:10px;">登入</a>
        </td></tr>
        <tr><td style="height:24px;"></td></tr>
        <tr><td style="font-size:11px;color:#9c8c87;line-height:1.7;">
          如果按鈕沒反應，把這串貼進瀏覽器：<br>
          <span style="word-break:break-all;color:#6b5c57;">${safeLink}</span>
        </td></tr>
        <tr><td style="height:28px;"></td></tr>
        <tr><td style="font-size:11px;font-style:italic;color:#9c8c87;text-align:right;">— 教練</td></tr>
      </table>
    </td></tr>
  </table>
</body>
...
// lead row + sends this email with a link to the《價值觀挖掘指南》placeholder PDF
...
/**
 * 暖短信 + 一顆「下載你的指南」按鈕。Plain HTML (no external CSS/images) —
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#FBF6EC;padding:48px 16px;">
    <tr><td align="center">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;background:#FFFFFF;border:0.5px solid #BFD7BA;border-radius:14px;padding:40px 32px;">
        ...
        <tr><td style="height:28px;"></td></tr>
        <tr><td align="center">
          <a href="${safe}" clicktracking="off" style="display:inline-block;padding:14px 36px;background:#3E9D5C;color:#FFFFFF;text-decoration:none;font-size:15px;letter-spacing:4px;border-radius:10px;">下載你的指南</a>
        </td></tr>
        <tr><td style="height:24px;"></td></tr>
        <tr><td style="font-size:11px;color:#A7BCA4;line-height:1.7;">
          如果按鈕沒反應，把這串貼進瀏覽器：<br>
          <span style="word-break:break-all;color:#6E8A6E;">${safe}</span>
        </td></tr>
        <tr><td style="height:28px;"></td></tr>
