...
export const CASCADE_PRIORITY = Object.freeze({
  ...
  E3_deep_signal_detector:      20,  // 深創傷訊號（不能被 opening 吞）
  E3_opening_branch_router:     30,  // 特殊開場分支
  E3_top1_determination:        40,  // Top 1 判定（Containment Judgment）
  E3_status_router:             50,  // 4 條主路由
  E3_cascade_down_validator:    60,  // Top 2/3 驗證
