...
test('CASCADE_PRIORITY: 7-step chain with E1 before E2', () => {
  ...
  // E3 deep_signal must come before E3 opening_branch (deep trauma can't be "opening")
  assert.ok(CASCADE_PRIORITY.E3_deep_signal_detector < CASCADE_PRIORITY.E3_opening_branch_router);
  // Full order check
  const order = [
