...
//   in_day1   — 正在 Day 1: !is_blocked AND days_completed === 0 (註冊但沒完成 Day 1; Vivi 6/19).
...
export function matchesCoachFilter(s, filter, now) {
  ...
  switch (filter) {
    ...
    // 6/19 Vivi — 正在 Day 1: 註冊但還沒完成 Day 1 (days_completed=0). 抓「路人卡在 Day 1」.
    case 'in_day1':  return !blocked && daysDone === 0;
