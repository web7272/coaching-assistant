...
test('🛑 6/8 v7-V2: cta-d-3 內文換新 (verbatim「該你了。我們製作了一份PDF…聚焦在你想要的人生。」)', () => {
  ...
  assert.match(actionCard[0],
    /<p class="cta-d" id="cta-d-3">該你了。我們製作了一份PDF 跟一個價值觀AI教練，模擬真實教練對話的方式，幫你把能量對齊，聚焦在你想要的人生。<\/p>/);
...
test('🛑 6/8 v9-② anti-regression: 不能誤改展開鈕 .cta-button「開始看見自己 →」', () => {
  ...
  assert.ok(actionCard);
  // 展開鈕 0 改, 仍保留 v6/C 文字.
  assert.match(actionCard[0], /<p class="cta-button" id="cta-go-3"><span>開始看見自己<\/span>/);
});
