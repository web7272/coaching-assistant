...
test('phaseSequenceIndex: known phases map to 0..7', () => {
  assert.equal(phaseSequenceIndex('phase_1'), 0);
  assert.equal(phaseSequenceIndex('phase_2'), 1);
  assert.equal(phaseSequenceIndex('phase_3a'), 2);
  assert.equal(phaseSequenceIndex('phase_3b'), 3);
  assert.equal(phaseSequenceIndex('phase_4'), 4);
  assert.equal(phaseSequenceIndex('phase_5'), 5);
  assert.equal(phaseSequenceIndex('integration_retention'), 6);
  assert.equal(phaseSequenceIndex('program_completed'), 7);
});
