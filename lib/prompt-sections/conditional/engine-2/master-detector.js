...
export const QUALITY_TERMS = Object.freeze({
  ...
  blacklist_tiers: Object.freeze({
    ...
    tier1_absolute_reject: [
      ...
      // ⭐ Step 7 PR-7b — 自我重要性 Landmine (errata v0.2 Patch 5.4).
      //   Damon: 「如果目標是為了證明自己是誰、通常出於虛弱的自我感與自負」
      //   「權力 / 地位 / 自豪 (Pride) 帶來的滿足感像毒品」
      //   ⚠️ 被看見 / 被肯定 / 被注意 — 已在上面、Step 7 強化「identity-claim context」
      //      由 prompt + handler context filter 共同把關 (避免事實陳述誤判).
      '證明自己', '證明自己的', '證明我是', '證明我是的',
      '讓人知道我是', '讓人知道我是的',
      '自我重要性', '自我重要性的',
      '自豪', '自豪的',   // when claimed as quality (handler context filter 區分 Pride vs 真正的 confidence)
      '被看見', '被看見的', '被注意', '被注意的',
    ],
