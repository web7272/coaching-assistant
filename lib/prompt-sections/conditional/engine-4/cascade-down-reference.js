...
// trigger: paired (跟 E3_cascade_mode_validator pair、in-line 過渡引用)
...
本 inject 只生成 1-2 句過渡引用、然後 handoff 給 E3_cascade_mode_validator 執行身份測試。
...
Inject 結束、E3_cascade_mode_validator 接手執行身份測試問句:
> 「你是一個『[next value]』的人嗎?」`;

export default {
  id: 'E4_cascade_down_reference',
  type: 'conditional_inject',
  trigger_event: 'paired',  // ⭐ paired with E3_cascade_mode_validator
  priority: null,
  paired_with: 'E3_cascade_mode_validator',
  ...
  trigger_conditions: [
    ...
    'E3_cascade_mode_validator 同 turn 觸發、本 inject 在 E3 之前 inject',
  ],
  parse_state_patch: {
    description: 'No state write — pure transition reference; E3_cascade_mode_validator handles state',
    affects: [],
  },
  inputs_from_state: [
