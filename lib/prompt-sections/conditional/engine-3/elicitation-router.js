...
Reference:cached mode_aware_router_reference 內 Mode 1 Elicitation section (主動 surface 學員核心 value)。
...
[Reframe Library 接口 — Step 7 PR-7a 接管]
  elicitation mode default reframe 優先序 (per §9 stacking MODE_DEFAULTS):
    1. R5 Away From → Toward (學員 surface「不要 X」型 negative want)
    2. R1 Reclaim Source (學員 surface 投射型「他給我 / 她讓我」)
    3. R4 Money as Fuel (學員 surface 金錢/物質衝突 + Top 1 非物質本身)
    4. R6 第一感知位置回歸 (學員「都先想別人」型 self-neglect)
  從 lib/damon-reframe-library/ 取對應 R 模組 buildInject() 填空 invoke.
  §9 stacking 規則由 lib/damon-reframe-library/stacking.js pickReframeForTurn 仲裁.`;
