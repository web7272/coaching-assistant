...
- cached mode_aware_router_reference 內 Mode 3 Integration section (整合反例 + 良善動機挖掘).
...
→ check-resistance (phase-3a 5 種破解).
  ⭐ Step 7 PR-7b: 若學員自然 surface「過去決定 / 拖著不做的事 + 情緒」
   → cascade R12 Hero's Welcome 4 步驟 SOP (lib/sub-prompts/integration/heros-welcome-4-step-sop.js).
   ⚠️ phrasing 全部 TODO Vivi 終審、本 router 只 reference、不寫死.
   若 trigger 條件不命中 → 沿用既有 check-resistance fallback、不發明.
