...
// ⭐ §3 patch 6/4 + 6/6 active SI hotfix — passive 強訊號 + 第一人稱 active SI.
//
//   regex 涵蓋:
//     (i)  passive ideation 明說想死 / 希望死 (原 6/4)
//     (ii) active SI 第一人稱意念 (我?想自殺 / 我?要自殺 / 結束 (自己|生命) /
//          我想死 / 我要死 / 活不下去) — 6/6 hotfix.
//
//   ⚠️ Patrick ground-truth root-cause (6/6): pre-hotfix 「我想自殺」 ONLY hit
//   TRAUMA_REGEX_PATTERN (含「自殺」, original intent: 「親人自殺」 trauma marker)
//   → 走變體 A trauma path. Vivi 6/6: active SI 第一人稱意念 must win PASSIVE_STRONG
//   first (engine-3 handler checks passive_strong BEFORE trauma) → C-1 強訊號 →
//   crisis-sop SI confirm → Step 4 high_risk direct-1925.
//
//   ⚠️ 「自殺/上吊」保留在 TRAUMA_REGEX_PATTERN (不移除) — covers 「親人自殺」/
//   「我爸上吊」 創傷 scenes. 不包含「我?想/要」第一人稱 → not hit by new active
//   SI patterns → 自然落 TRAUMA 路徑.
//
//   Pattern additions (Vivi 6/6 spec literal):
//     我?想自殺         — 「我想自殺」 / 「想自殺」
//     我?要自殺         — 「我要自殺」 / 「要自殺」
//     結束.{0,3}(自己|生命) — 「結束自己」/「結束生命」/「結束我的生命」
//     我想死 / 我要死   — 第一人稱明確
//     活不下去          — 第一人稱當下狀態
//     不想活了          — 第一人稱當下意念 (existing 「不想活」 substring already
//                         catches, included for documentation completeness)
export const PASSIVE_STRONG_REGEX = /(不想活|不想活下去|不想再活|不想繼續活|想結束生命|想離開這世界|希望.{0,5}死|希望.{0,5}離世|希望.{0,5}死亡|希望.{0,8}生病.{0,8}死|希望.{0,5}快點走|不會傷害自己.{0,5}希望|我?想自殺|我?要自殺|結束.{0,3}(自己|生命)|我想死|我要死|活不下去|不想活了)/;
