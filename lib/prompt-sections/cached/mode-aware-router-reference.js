...
export default {
  ...
  token_estimate: 1600,
  content,
  source: 'v51_cached_section3_mode_aware_router_reference.md §3 (line 21-297 verbatim)',
  designer_delivered_at: '2026-06-05',
  spec_version: 'v0.1',
  cache_invalidation_note: '本檔替換 v5.0 four-seven-router、cache invalidate 一次。'
    + 'Patrick 排程「跟 Step 10 一起算」(16 場 simulation 觸發 re-warm).',
  used_by: [
