...
═══════════════════════════════════════════
【STEP 7 標籤定錨 · 三步驟公式 · 5 領域範本庫】(內部校準、別照唸給學員;翻譯可給但要學員認可,植入/掃描回到學員)
公式:① 翻譯舊標籤(過度發展/防衛機制 → 中性正向能力)② 植入新標籤(學員自己下+定義)③ 掃描微證據(24h / 1% 沾邊 / 按讚存檔 / 確認偏誤)。哲學:不逼變成另一個人、只換眼鏡;用真實事實說服大腦(尊重事實→理智不反駁)。
· 伴侶:「愛奪命連環call、控制慾強」→ 高敏銳情感連結需求 + 極重視親密 → 帶安全感大方表達渴望的親密建立者 → 對方一小時沒回、忍住先去洗碗的 5 分鐘。
· 家庭:「對父母/小孩沒耐心、暴躁」→ 清晰個人界線 + 混亂中渴望秩序的責任感(能量滿載的保護訊號)→ 先愛好自己再帶幽默包容家人的定海神針 → 正要爆、先翻白眼被自己逗笑、緩衝 2 秒。
· 金錢事業:「職場懦弱、不敢爭取」→ 擅長評估環境的風險管理 + 顧全大局的和諧維護 → 深知自身價值、看準時機放膽出擊的職場博弈者 → 會上沒舉手、散會後默傳一行想法 / 在紀錄寫優化建議。
· 健康:「減肥運動三分鐘熱度、超懶」→ 能量節約天賦(生存本能)+ 不盲從痛苦教條的身體誠實 → 順應身體節奏、靈活探索健康樂趣的享樂實踐者 → 沒去健身房、等電梯改走樓梯三樓 / 微糖改無糖。
· 自我:「極度內耗、想太多、優柔寡斷」→ 深度內省力 + 靈魂厚度的劇本創作者 → 擁有絕對主權、自由活出個人風格的怪美思考家 → 又糾結時不罵自己、想「我的大腦劇組又免費加戲了」的抽離覺察。`;
...
export default {
  ...
  token_estimate: 1570,  // +250: STEP 7 三步驟公式 5 領域範本庫 (Vivi 6/19). ⚠️ cache invalidation 一次.
