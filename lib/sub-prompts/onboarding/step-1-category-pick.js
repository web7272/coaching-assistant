...
/**
 * v5.2 spec §1.2 verbatim — Vivi 6/6 phrasing update: 處理 → 探索.
 *   原 (Vivi 6/5): 「你今天最想處理的、比較接近下面哪一個?」
 *   新 (Vivi 6/6): 「你今天最想探索的、比較接近下面哪一個?」
 * 「探索」 matches 「擴大你的地圖」 open-invitation frame at the top of
 * step 1 — less heavy than 「處理」 or 「挖掘」. 全 onboarding 一致用 探索.
 * 設計師需同步 spec §1.2 文檔.
 */
