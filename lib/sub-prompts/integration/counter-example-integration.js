...
//
// ⭐ v5.0 原創 IP #2 (errata 5/21 intent 修正):
// 亞洲文化適配的 **default 拆解節奏**、不是「適配選項」、是 default。
// 含:
//   - §5.8.2 畫布技術(Phase 3a Step 1a 起手保留)
//   - 不問為什麼、強制翻轉(E3 opening branch)
//   - 主動引出反例(本檔)
//   - respect binary 框架(Phase 3b §9.7 P18 mitigation)
//
...
→ Vivi 5/21 review: 移除「身體哪裡感覺到?」、違反紅線 14、亞洲學員無感、
  v5.0 用 Scope Overlap 替代 submodality
