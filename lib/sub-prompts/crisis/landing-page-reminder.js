...
//
// ⭐ 6/7 P0 safety (Vivi A016): Step 6 is the next-turn destination after
//    Step 4 1925 for active SI fast-path. Production smoke caught AI
//    improvising「想自殺」+ SI re-question after this inject. Prohibition
//    block now appended to every reminder variant so the rules persist
//    multi-turn.
import { CRISIS_OUTPUT_PROHIBITIONS } from './_phrasings.js';
