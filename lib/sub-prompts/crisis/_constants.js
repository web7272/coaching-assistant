...
export const HANDOFF_VARIANT = Object.freeze({
  STANDARD: 'standard',   // 4.1 三選一 a/b/c
  REMOVE_C: 'remove_c',   // 4.2 count >= 3, 移除 (c)
  ONLY_B:   'only_b',     // 4.3 SI confirm + plan OR no protective factor
  FREEZE:   'freeze',     // 4.4 count >= 5
});
