...
const STEP_5_1_STANDARD = `Step 5.1 — 標準 1925 提供 (turn2b §10.3 step 5.1 + 6/6 wording 修訂, Vivi 6/6):
...
⭐ 6/6 wording 修訂 (Vivi 6/6, 話術定稿-crisis-去書面腔+1925台灣框.md):
- 1925 改用「安心專線」naming (口語、減低 stigma).
- 加非台灣兜底句 (1925 一律框「台灣」localization safety net).
- 去「很重」書面腔.
- 偵測 regex (deep-signal-detector) + safety-planning 護欄 = system 端、保留不動.`;
