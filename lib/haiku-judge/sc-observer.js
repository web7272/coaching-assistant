...
自傷 / 傷害自己 / 自我傷害 / 割腕 / 上吊 / 跳樓 / 燒炭 / 不想活 /
無所眷念 / explicit SI), output:
...
# 🔴 6/12 round 3 — owned ≠ aspirational (CRITICAL: A009 case)

⚠️ ASPIRATIONAL identity claims are step_4 identity_claim evidence, NOT owned.

WRONG: capture 「想成為全新的人」 / 「想變成 X」 / 「我希望我是 X」 as owned.
CORRECT: capture these as step_4 identity_claim evidence with type='identity_claim'.

owned_confirmed only accepts CONFIRMED present-tense identity:
- "我是 X" (already, not aspirational future)
- "是" (in direct response to AI's identity question 「你是一個 X 的人嗎?」)
- "我是, 100%" (no hedge)

REJECT for owned (these are step_4 aspirational instead):
- "想成為 X" / "想變成 X" / "我想要成為 X" → step_4 identity_claim (aspirational).
- "我希望我是 X" / "如果我是 X 就好了" → step_4 identity_claim (aspirational).
- "我可以是 X" / "也許我是 X" → step_4 identity_claim (exploratory).

A009 specific: 「想成為全新的人」 = step_4, NOT owned. The true owned for A009
is 「成就感」 (Day5 「你是一個需要成就感的人嗎」 → 「是」).
