...
開場已過、用 Damon 鏈式追問「擁有這個對你有什麼重要?」、不重複起手式。`,
    ...
    day_opening_inject: `【Phase 1：Values Elicitation — 跨日開場（由 E4 主導）】
目標：Damon 鏈式追問挖出 3-5 個 values、用 Containment Judgment 定 Top 1。
day range：min 1 / max 4 session days。
exit：top1_value 確定 + Goal Alignment Test 通過 → Phase 2。
本 turn 由 [SYSTEM INJECT — Day Opening Active Reference] 主導開場：依其 V1-V5
變體話術引用昨天的 takeaway、自然接續對話。**不另起 phase_1 起手式**、不問
「在你的生命裡你想要什麼」這類冷開場。E4 的話術就是今天的開場句。`,
  }),
