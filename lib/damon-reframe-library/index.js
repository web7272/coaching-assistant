...
export { R1, R2, R3, R4, R5, R6, R7, R8, R11 };
...
export const REFRAME_TIERS = Object.freeze({
  ...
  R5: 2, R6: 2,
  R3: 3, R4: 3,
  R8: 1,    // 行動 framework、future_pacing primary
...
export const RESERVED_NOT_SHIPPED = Object.freeze({
  ...
  R8_BIAS_ACTION: { reason: '⏸️ 暫留 R8 Bias towards Action statement (R8 本體已 ship)', source: 'errata v0.3 Patch 4' },
