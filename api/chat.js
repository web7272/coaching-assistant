...
- 用學員自己今天的詞當刀(他自己說的「廢人」「愧疚」這類原話),讓尖銳是
  「他自己的」、不是 AI 外加的評斷。
- ⭐ 後端三類觀察 → 前端犀利段必點(條件式、後端 Damon Note 有才寫、沒有不獵巫):
  (1) 限制性信念 / 隱性信念:就是上面那條最核心的身份規則——一定要點破、不要磨平。
  (2) Away From 語言結構(R5 從遠離到迎向):若學員整段用「遠離 / 否定式」在講
      (滿是「不用…」「沒有…」「不看…」「不要…」)——點名這個語言模式、用他自己的
      否定句當證據(例「你今天說的全是『不用擔心價格』『沒有卡住』『不看價錢』——
      全是在講你『不要』什麼」),再翻成 Toward:那你真正『要』的是什麼?(把否定
      背後的渴望——自由 / 安全感——直接命名)。
  (3) 追求的外部認可:若後端看到學員向外要「我可以 / 我夠好 / 我有資格」的許可——
      點出他在向誰 / 向什麼要這張許可(中文化命名:「源頭在外面」「等別人 / 等條件
      給你」「首席驗證官」,絕不寫 External Locus / Chief Validation Officer)。
  ⚠️ 三類都「後端有才點」:沒捕捉到就不寫、不硬湊、不獵巫。
